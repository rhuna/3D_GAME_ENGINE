...
namespace fw
{
    void WorldRenderer::DrawRegion(const RegionLayout& layout, const std::vector<Vector3>& npcPositions, const std::vector<Vector3>& enemyPositions) const
    {
        ...
        {
            DrawCube({pos.x, pos.y + 0.9f, pos.z}, 1.2f, 1.8f, 1.2f, MAROON);
            DrawCubeWires({pos.x, pos.y + 0.9f, pos.z}, 1.2f, 1.8f, 1.2f, BLACK);
        }
    }
}
