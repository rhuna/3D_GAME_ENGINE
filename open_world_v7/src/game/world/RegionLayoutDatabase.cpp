...
void RegionLayoutDatabase::LoadDefaults(){
    m_layouts.clear();
    RegionLayout village{}; village.regionId="village_region"; village.playerSpawn={0,1,0};
    ...
    village.npcSpawns={{2,1,-2},{-5,1,3}}; village.gatherPoints={{8,1,8}}; village.travelPoints={{20,1,0},{-20,1,0}};
    m_layouts[village.regionId]=village;

    RegionLayout forest{}; forest.regionId="forest_region"; forest.playerSpawn={0,1,0};
    ...
    forest.npcSpawns={{-6,1,4}}; forest.gatherPoints={{3,1,6},{10,1,-2},{-12,1,-4}}; forest.travelPoints={{-25,1,0},{25,1,0}};
    forest.enemySpawns.push_back({{8,1,10},"wolf"}); forest.enemySpawns.push_back({{-10,1,-8},"wolf"}); forest.enemySpawns.push_back({{12,1,-12},"raider"});
    m_layouts[forest.regionId]=forest;

    RegionLayout ruins{}; ruins.regionId="ruins_region"; ruins.playerSpawn={0,1,0};
    ...
    ruins.gatherPoints={{2,1,-6}}; ruins.travelPoints={{0,1,-22}};
    ruins.enemySpawns.push_back({{5,1,6},"brute"}); ruins.enemySpawns.push_back({{-8,1,-10},"raider"});
    m_layouts[ruins.regionId]=ruins;
}
const RegionLayout* RegionLayoutDatabase::Find(const std::string& regionId) const { auto it=m_layouts.find(regionId); return it==m_layouts.end()?nullptr:&it->second; }
}
